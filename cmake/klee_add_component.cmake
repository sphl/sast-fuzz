...
function (klee_add_component target_name)
    # Components are explicitly STATIC because we don't support building them as shared libraries.
    ...
    if (("${CMAKE_VERSION}" VERSION_EQUAL "3.3") OR ("${CMAKE_VERSION}" VERSION_GREATER "3.3"))
        ...
        target_compile_options(${target_name} PUBLIC $<$<COMPILE_LANGUAGE:CXX>:${KLEE_COMPONENT_CXX_FLAGS}>)
    else ()
        # For older CMakes just live with the warnings we get for passing C++ only flags to the C compiler.
