...
class AssignmentGenerator {
  ...
  private:
    static bool
    helperGenerateAssignment(const ref<Expr> &e, ref<Expr> &val, Assignment *&a, Expr::Width width, bool sign);
    ...
    getIndexedValue(const std::vector<unsigned char> &c_val, ConstantExpr &index, const unsigned int size);
};
}  // namespace klee
