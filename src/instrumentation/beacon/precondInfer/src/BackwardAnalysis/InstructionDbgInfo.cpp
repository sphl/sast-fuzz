...
unsigned InstructionDbgInfo::instToLine(const llvm::Instruction *inst) { return instance->instToAsmLine.at(inst); }

const llvm::Instruction *InstructionDbgInfo::lineToInst(unsigned line) { return instance->asmLineToInst.at(line); }

bool InstructionDbgInfo::hasLineInfo(const llvm::Instruction *inst) { return instance->instToAsmLine.count(inst); }
