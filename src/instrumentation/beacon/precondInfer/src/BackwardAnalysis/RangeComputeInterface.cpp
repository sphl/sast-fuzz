...
bool RangeComputeInterface::isCondUnSat(const klee::ref<klee::Expr> &cond) { return analyze(cond)->isCondUnSat(); }
...
std::pair<llvm::APInt, llvm::APInt> RangeComputeInterface::getRange(const klee::ref<klee::Expr> &cond,
                                                                    const klee::ref<klee::Expr> &sym) {
