...
static const u8 count_class_human[256] = {
        ...
        [0] = 0,        [1] = 1,         [2] = 2,          [3] = 3,          [4 ... 7] = 4,
        [8 ... 15] = 5, [16 ... 31] = 6, [32 ... 127] = 7, [128 ... 255] = 8
...
static u32 write_results(void) {
    ...
    u8 cco = !!getenv("AFL_CMIN_CRASHES_ONLY"), caa = !!getenv("AFL_CMIN_ALLOW_ANY");
...
static void run_target(char **argv) {
    ...
    classify_counts(trace_bits, binary_mode ? count_class_binary : count_class_human);
...
static void show_banner(void) { SAYF(cCYA "afl-showmap " cBRI VERSION cRST " by <lcamtuf@google.com>\n"); }
